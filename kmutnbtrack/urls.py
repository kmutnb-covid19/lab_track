...
urlpatterns = [
    ...
    path('lab/<str:lab_hash>/qrcode', views.generate_qr_code, name='show_qr_code'),
    ...
    path('auth_head/<uidb64>/<token>/', views.auth_head, name='auth_head'),
    path('auth_staff/<uidb64>/<token>/', views.auth_staff, name='auth_staff'),
]
